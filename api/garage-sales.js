export default async function handler(req, res) {
  ...
  try {
    const rssUrl = `https://${subdomain}.craigslist.org/search/sss?query=garage+sale+rummage+sale+church+sale+estate+sale+moving+sale&format=rss&lat=${userLat}&lon=${userLng}&search_distance=15`;
